...
@Component({
  ...
  template: `
    <section fxLayout="column" fxLayout.gt-sm="row" class="container">
      ...
      <p>My name is Dawid. If you'd like to reach out to me, please find me on <a href="https://www.linkedin.com/in/dawid-sip-a41a412a1/" target="_blank" class="linkedin-link">LinkedIn</a>.
      </p>
      </div>
